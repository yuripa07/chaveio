  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 id="kick-dialog-title" className="text-base font-bold text-zinc-900">
          {t.common.kickTitle}
        </h2>
        ...
        <div className="mt-5 flex gap-2">
          <button
            ...
            onClick={onCancel}
            disabled={isLoading}
            className="flex-1 rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm font-semibold text-zinc-600 hover:bg-zinc-50 transition-colors disabled:opacity-40"
          >
            {t.common.cancel}
          </button>
          <button
